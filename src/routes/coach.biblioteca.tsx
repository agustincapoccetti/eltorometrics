    ...
    <Shell title="Biblioteca">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {filtered.map((it) => (
            <div key={it.id} className="border border-border p-4 flex flex-col">
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div><Label>Enlace (video o web)</Label><Input value={form.url} onChange={(e) => setForm({ ...form, url: e.target.value })} placeholder="https://..." /></div>
